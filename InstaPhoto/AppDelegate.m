...
//    
//    UIViewController *favoriteViewController = [[UIViewController alloc] init];
//    favoriteViewController.title = @"Favorite";
//    
////    feedViewController.view.backgroundColor = [UIColor blueColor];
//    favoriteViewController.view.backgroundColor = [UIColor redColor];
//    
...
//    [tabController setViewControllers:@[navController, favoriteViewController, profileViewController]];
//
